...
De bestaande Composer-installatieroute roept `pitboard:upgrade-notification-storage` aan. Deze draait alleen die ene migratie, onder een slot, en stopt bij verschil tussen migratiehistorie en tabelaanwezigheid. Test bewijst behoud van overige tabellen en herhaalbaarheid. Live moet de daadwerkelijke meldingen-API en voorkeurenpagina werken; alleen nieuwe assets bewijzen geen geslaagde migratie.

...
class AssetCacheTest extends TestCase
{
    public function test_app_shell_is_not_cached_and_local_assets_have_a_version(): void
    {
        ...
        $this->assertStringContainsString('/css/style.css?v=20260902-2', $appShell);
        $this->assertStringContainsString('/js/app.js?v=20260902-2', $appShell);
        $this->assertStringContainsString('/js/converter.js?v=20260902-2', $appShell);
        $this->assertStringContainsString('/js/settings.js?v=20260902-2', $appShell);
    }
}

...
class AssetCacheTest extends TestCase
{
    public function test_app_shell_is_not_cached_and_local_assets_have_a_version(): void
    {
        ...
        $this->assertStringContainsString('/js/notifications.js?v=20260924-6', $appShell);
        ...
        $this->assertStringContainsString('/js/settings.js?v=20260922-1', $appShell);
        ...
        $this->assertStringContainsString('/js/dashboard-layout.js?v=20260924-2', $appShell);
    }
}

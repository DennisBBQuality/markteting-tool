    ...
    <section class="product-image-card" aria-labelledby="product-image-title">
      <div class="product-image-header">
        <div>
          ...
          <p><i class="fas fa-circle-check" style="color:var(--success);"></i> BBQuality-stijlbibliotheek actief: één vaste rauwe achtergrond en verschillende bereide sferen.</p>
        </div>
